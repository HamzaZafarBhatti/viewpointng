                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      <div class="input-group input-group-merge input-group-alternative">
                        ...
                        <input class="form-control" placeholder="" type="text" name="coupon" required>
 						
                      </div>
                      <a href="{{route('coupon')}}" style="text-decoration: none;color:white">No code? Click here to BUY Activation code </a>
                    </div> 
