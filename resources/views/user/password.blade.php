...
<p><span style="color: #ffffff;"><strong>Kindly change your password to a more secure password or preferred one.</strong></span></p>
                ...
                {{-- <div class="col-md-6">
                    ...
                    <div class="card bg-dark">
                        <div class="card-header header-elements-inline">
                            <h3 class="mb-0 text-white">Change Pin <span>(Default pin on registration is <span
                                        class="">0000</span></span>)</h3>
                        </div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('user.change_pin') }}" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="password" name="current_pin" class="form-control bg-dark text-white"
                                            required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="password" name="pin" class="form-control bg-dark text-white"
                                            required>
                                        @if ($errors->has('pin'))
                                            <span class="error form-error-msg ">
                                                {{ $errors->first('pin') }}
                            ...
                            <div class="align-item-sm-center flex-sm-nowrap text-left">
                                <div class="">
                                    <p>
                                        ...
                                        When it is activated you need to enter not only your password, but also a special
                                        code.
                                    ...
                                    <form action="{{ route('change.2fa') }}" method="post">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                <input type="number" name="code" class="form-control bg-dark text-white"
                                                    required>
...
@section('script')
    ...
    @if (session('pin_success'))
        <script>
            "use strict";
            $(document).ready(function() {
                swal("PIN Change Confirmation from Email is Pending", "{{ session('pin_success') }}", "success");
            });
        </script>
    @endif
@endsection
