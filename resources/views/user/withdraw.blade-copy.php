                    ...
                    <div class="card bg-dark">
                        <div class="card-header header-elements-inline bg-transparent">
                            ...
                            <p><span style="color: #ffffff;">Withdrawal is automatically PAID To your Bank account after
                                    each Request.</span></p>
                            <p><span style="color: #ffffff;">You can request your GoldMint Mine Amount, GoldMint Profit, and
                                    Referral Earnings.</span></p>
                            <p><span style="color: #ffffff;">AVAILABLE AMOUNT TO WITHDRAW: <span
                                        style="color: #ffcc00;">Mine Balance: ₦{{ substr($user->balance, 0, 9) }}</span> |
                                    <span style="color: #ffcc00;">GoldMint Profit:
                                        ₦{{ substr($user->profit, 0, 9) }}</span> | <span style="color: #ffcc00;">Referral
                                        Earnings: ₦{{ substr($user->ref_bonus, 0, 6) }}</span></span></p>
                            <p>
                                <span style="color: #ffffff;">WITHDRAWAL START TIME (MINER BALANCE, SPONSOR BALANCE): </span>
                                <span style="color: #ffcc00;">{{ \Carbon\Carbon::parse($set->withdraw_start)->format('l jS \\of F Y h:i:s A') }}</span>
                            </p>
                            <p>
                                <span style="color: #ffffff;">WITHDRAWAL END TIME (MINER BALANCE, SPONSOR BALANCE): </span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <select class="form-control select bg-dark text-white" name="type" id="type"
                                            required>
                                            <option value="1">GoldMint Profit</option>
