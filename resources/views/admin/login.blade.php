                    ...
                    <div class="w-100">
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                ...
                                <form class="mt-4 pt-2" action="{{ route('admin.do_login') }}" method="POST">
                                    @csrf
                                    <div class="form-floating form-floating-custom mb-4">
                                        <input type="text" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', 'admin') }}" id="input-username" placeholder="Enter User Name" name="username">
                                        @error('email')
