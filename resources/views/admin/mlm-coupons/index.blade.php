            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold">Generate MLM Coupon</h6>
                    </div>
                    <div class="card-body">
                        <p class="text-danger"></p>
                        <form action="{{ route('admin.mlm-coupons.store') }}" method="post">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control select" name="mlm_plan_id" data-fouc required>
                            ...
                            <tbody>
                                @foreach ($coupons as $k => $val)
                                    <tr>
                                        <td>{{ ++$k }}.</td>
                                        <td>{{ $val->serial }}</td>
                                        <td>{{ $val->mlm_plan ? $val->mlm_plan->name : 'N/A' }}</td>
                                        <td>
                                            @if ($val->status)
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="{{ route('admin.mlm-coupons.destroy', $val->id) }}"
                                                        ...
                                                        <form id="logout-form{{ $val->id }}"
                                                            action="{{ route('admin.mlm-coupons.destroy', $val->id) }}"
