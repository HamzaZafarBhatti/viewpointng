                    ...
                    <div class="">
                        <table class="table datatable-show-all">
                            ...
                            @foreach($review as $k=>$val)
                                <tr>
                                    <td>{{++$k}}.</td>
                                    <td><img src="{{url('/')}}/asset/review/{{$val->image_link}}" style="height: auto; max-width: 100%;"></td>
                                    <td>{{$val->name}}</td>
                                        ...
                                        <div class="list-icons">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    @if($val->status==1)
                                                        <a class='dropdown-item' href="{{url('/')}}/admin/unreview/{{$val->id}}"><i class="icon-eye-blocked2 mr-2"></i>Unpublish</a>
                                                    @else
                                                        <a class='dropdown-item' href="{{url('/')}}/admin/preview/{{$val->id}}"><i class="icon-eye mr-2"></i>Publish</a>
                                                    @endif
                                                    <a href="{{url('/')}}/admin/review/edit/{{$val->id}}" class="dropdown-item"><i class="icon-pencil7 mr-2"></i>Edit</a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a  href="{{url('/')}}/admin/review/delete/{{$val->id}}" class="btn bg-danger">Proceed</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
