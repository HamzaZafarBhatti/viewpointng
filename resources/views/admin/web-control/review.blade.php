                    ...
                    <div class="card-header header-elements-inline">
                        ...
                        <div class="header-elements">
                            <a class="font-weight-semibold" data-toggle="modal" data-target="#create"><i
                                    class="icon-file-plus mr-2"></i>Create review</a>
                        </div>
                    </div>
                    <div class="">
                        <table class="table datatable-show-all">
                            ...
                            <tbody>
                                @foreach ($review as $k => $val)
                                    <tr>
                                        <td>{{ ++$k }}.</td>
                                        <td><img src="{{ url('/') }}/asset/review/{{ $val->image_link }}"
                                                style="height: auto; max-width: 100px;"></td>
                                        <td>{{ $val->name }}</td>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        @if ($val->status == 1)
                                                            <a class='dropdown-item'
                                                                href="{{ route('admin.review.unpublish', $val->id) }}"><i
                                                                    class="icon-eye-blocked2 mr-2"></i>Unpublish</a>
                                                        @else
                                                            <a class='dropdown-item'
                                                                href="{{ route('admin.review.publish', $val->id) }}"><i
                                                                    class="icon-eye mr-2"></i>Publish</a>
                                                        @endif
                                                        <a href="{{ route('admin.review.edit', $val->id) }}"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="{{ route('admin.review.delete', $val->id) }}"
    ...
    <div id="create" class="modal fade" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.createreview') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
