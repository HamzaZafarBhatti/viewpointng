            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold">Generate Stake Coupon</h6>
                    </div>
                    <div class="card-body">
                        <p class="text-danger"></p>
                        <form action="{{ route('admin.stake_coupons.store') }}" method="post">
                            @csrf
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2">Stake Codes Quantity:</label>
                                <div class="col-lg-10">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2">Stake Plan:</label>
                                <div class="col-lg-10">
                                    <select class="form-control select" name="stake_plan_id" data-fouc required>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="{{ route('admin.stake_coupons.destroy', $val->id) }}"
                                                            onclick="event.preventDefault(); document.getElementById('logout-form{{ $val->id }}').submit();"
                                                            class="btn bg-danger">Proceed</a>
                                                        <form id="logout-form{{ $val->id }}" action="{{ route('admin.stake_coupons.destroy', $val->id) }}"
    ...
    <script>
        ...
        if ('{{ Session::get('download_link_stake') }}') {
            ...
            $('#download_link').removeClass('disabled').attr('href',
                '{{ url(Session::get('download_link_stake') ?? "https://rubicnetwork.com/rubicnetworkadministration") }}').trigger('click');
        } else {
