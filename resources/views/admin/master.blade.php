...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Ubuntu:400,300,100,500,700,900" rel="stylesheet"
        type="text/css">
    <link href="{{ url('/') }}/asset/global_assets/css/icons/icomoon/styles.css" rel="stylesheet" type="text/css">
    <link href="{{ url('/') }}/asset/global_assets/css/icons/fontawesome/styles.min.css" rel="stylesheet"
        type="text/css">
    ...
    <script src="{{ url('/') }}/asset/global_assets/js/plugins/tables/datatables/extensions/buttons.min.js"></script>
    <script src="{{ url('/') }}/asset/global_assets/js/plugins/tables/datatables/extensions/responsive.min.js">
    </script>
    ...
    <script src="{{ url('/') }}/asset/global_assets/js/demo_pages/picker_date.js"></script>
    ...
    <script src="{{ url('/') }}/asset/global_assets/js/demo_pages/datatables_extension_buttons_init.js"></script>
    ...
    <div class="navbar navbar-expand-md navbar-light navbar-static">
        ...
        <div class="collapse navbar-collapse" id="navbar-mobile">
            ...
            <span class="navbar-text ml-md-3 mr-md-auto">
                ...
                Welcome back, {{ Auth::guard('admin')->user() ? Auth::guard('admin')->user()->username : 'NA' }}
            </span>
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown dropdown-user">
                    <a href="#" class="navbar-nav-link dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span>{{ Auth::guard('admin')->user() ? Auth::guard('admin')->user()->username : 'NA' }}</span>
                    </a>
                    ...
                    <ul class="nav nav-sidebar" data-nav-type="accordion">
                        ...
                        {{-- <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav nav-group-sub" data-submenu-title="Deposit">
                                <li class="nav-item"><a href="{{ route('admin.deposit.method') }}"
                                        class="nav-link"><i class="icon-puzzle4"></i>Payment gateways</a></li>
                                <li class="nav-item"><a href="{{ route('admin.deposit.log') }}"
                                        class="nav-link"><i class="icon-list-unordered"></i>Deposit log</a></li>
                                <li class="nav-item"><a href="{{ route('admin.deposit.pending') }}"
                                        class="nav-link"><i class="icon-spinner2 spinner"></i>Pending
                                        deposit</a></li>
                                <li class="nav-item"><a href="{{ route('admin.deposit.approved') }}"
                                        class="nav-link"><i class="icon-thumbs-up2"></i>Approved deposit</a>
                                </li>
                                <li class="nav-item"><a href="{{ route('admin.deposit.declined') }}"
                        ...
                        <li class="nav-item nav-item-submenu">
                            <a href="#" class="nav-link"><i class="icon-share2"></i><span>MLM Balance Wallet
                                    ...
                                    system</span></a>
                            <ul class="nav nav-group-sub" data-submenu-title="Withdraw">
                                <li class="nav-item"><a href="{{ route('admin.mlm.withdraw_log') }}"
                                        class="nav-link"><i class="icon-list-unordered"></i>Withdraw log</a>
                                </li>
                                <li class="nav-item"><a href="{{ route('admin.mlm.withdraw_unpaid') }}"
                                        class="nav-link"><i class="icon-spinner2 spinner"></i>Unpaid
                                        withdrawal</a></li>
                        ...
                        <li class="nav-item nav-item-submenu">
                            <a href="#" class="nav-link"><i class="icon-share2"></i><span>Referral Balance
                                    ...
                                    system</span></a>
                            <ul class="nav nav-group-sub" data-submenu-title="Withdraw">
                                <li class="nav-item"><a href="{{ route('admin.ref.withdraw_log') }}"
                                        class="nav-link"><i class="icon-list-unordered"></i>Withdraw log</a>
                                </li>
                                <li class="nav-item"><a href="{{ route('admin.ref.withdraw_unpaid') }}"
                                        class="nav-link"><i class="icon-spinner2 spinner"></i>Unpaid
                                        withdrawal</a></li>
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav nav-group-sub" data-submenu-title="News Section">
                                ...
                                <li class="nav-item"><a href="{{ route('admin.privacy_policy') }}"
                                        class="nav-link"><i class="icon-file-check"></i>Privacy policy</a></li>
                                {{-- <li class="nav-item"><a href="{{ route('admin.cookie_policy') }}"
                                        class="nav-link"><i class="icon-file-check"></i>Cookie policy</a></li> --}}
                                {{-- <li class="nav-item"><a href="{{ route('admin.disclaimer') }}"
