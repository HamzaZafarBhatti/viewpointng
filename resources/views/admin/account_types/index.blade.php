            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold">Add Account Types</h6>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold">Account Types</h6>
                    </div>
                    <div class="">
                        <table class="table datatable-show-all">
                            ...
                            <tbody>
                                @foreach ($account_types as $k => $val)
                                    <tr>
                                        <td>{{ ++$k }}.</td>
                                        <td>{{ $val->name }}</td>
                                        <td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class='dropdown-item'
                                                            href="{{ route('admin.account_types.edit', $val->id) }}"><i
